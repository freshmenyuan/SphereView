...
#include "stichingDetail.hpp"


stichingDetail::stichingDetail(){
...
Mat stichingDetail::stiching(vector<string>& img_names){
    ...
    {
        img_names.push_back(to_string(i) + "th.jpg");
    ...
    for (int img_idx = 0; img_idx < num_images; ++img_idx)
    {
        ...
        if (blender.empty())
        {
            ...
            if (blend_width < 1.f)
                blender = Blender::createDefault(Blender::NO_EXPOSURE_COMPENSATOR, try_gpu);
